...
import com.shoppingapp.view.ProductDetailActivity;
...
public class ProductsRecyclerAdapter extends RecyclerView.Adapter<ProductsRecyclerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        ViewDataBinding binding = DataBindingUtil.inflate(layoutInflater, R.layout.product_grid_item, viewGroup, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onClick(View v) {
            ...
            bundle.putParcelable(KEY_SELECTED_PRODUCT, product);
